...
public partial class Graph : Control
{
	...
	public override void _Draw()
	{
		...
		Vector2 YLabelPos = new Vector2(origin.X - Margin/2, origin.Y - Height/2);
		PushTransform(Transform2D(Mathf.DegToRad(-90), YLabelPos));
		DrawString(defaultfont, Vector2.Zero, "nox emmision [mg/nm3]", HorizontalAlignment.Left, -1, fontSize, labelColor);
		PopTransform();
		Vector2 XLabelPos = new Vector2(origin.X + Width/2, origin.Y);
